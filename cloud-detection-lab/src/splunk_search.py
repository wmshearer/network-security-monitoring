...
and print/save JSON results. Same pattern as splunk-ingest-pipeline's
src/splunk_search.py (that project is done and not touched here), reused
because SPL containing backslashes/quotes/wildcards is fragile to
